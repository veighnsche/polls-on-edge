...
export const CreatePage: FC = () => {
	...
	return (
		<section className="rounded-xl shadow p-10 flex flex-col items-center bg-card">
			<h1 className="text-2xl sm:text-3xl font-bold mb-6 text-primary text-center">Create a New Poll</h1>
			<PollForm submitLabel="Create Poll" onSubmitAction="/api/poll/create" />
		</section>
	);
};
